...
public class s3 extends JFrame {
    ...
    public s3() {
        ...
        selectModeButton = createToolbarButton("Select Mode", "icons/select.png");
        addNodeButton = createToolbarButton("Add Node", "icons/node.png");
        addEdgeButton = createToolbarButton("Add Edge", "icons/edge.png");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(s3::new);
    }
